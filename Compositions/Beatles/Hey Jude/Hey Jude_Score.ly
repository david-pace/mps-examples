...
\score {
    <<
        ...
        \new Staff {
            ...
            g'4 r2 g'8 a' |
            bes'4 f'' r8 f'' e'' c'' |
            d'' c''16 bes' a'4 r4. c''8 |
            d'' d'' r d'' g''16 f''8 e'' f''16 d''8 |
            c''4 r f'8 g' a' d'' |
            c''4 r8 c'' bes' a'4 e'16 f' |
            f'4 r2 c''4 |
            a' r4. a'8 c'' d'' |
            g'4 r2 g'8 a' |
            bes'4 f'' r8 f'' e'' c'' |
            d'' c''16 bes' a'4 r4. c''8 |
            d''16 d'' r8 r d'' g''16 f''8 e'' f''16 d''8 |
            c''4 r f'8 g' a' d'' |
            c''4 r8 c'' bes' a'4 e'16 f' |
            f'4 r2. \mark "Chorus"
            |
            r8. f'16 f'' d''8 d''8. c''8 c'' bes'16 d''~ |
            d''4 f''8 d''4. f''8 bes'~ |
            bes'4 f''8 d''4 c''8 bes' c''~ |
            c''4 d''8 c''4. bes'8 a'~ |
            a' g'16 f'4~ f'16 r2 |
            r8. f'16 f'' d''8 d''8. c''8 c'' bes'16 d''~ |
            d''4 f''8 d''4. f''8 bes'~ |
            bes'4 f''8 d''4 c''8 bes' c''~ |
            c''4 d''8 c''4 bes' a'8~ |
            a' g'16 f'4~ f'16 r8 f' c'' d'' \time 2/4
            \mark "Bridge"
            |
            es'' d'' es''4 \time 4/4
            |
        ...
        \new Staff {
            ...
            <e' g' bes' c''> <e' g' bes' c''> <e' g' bes' c''> <e' g' bes' c''> |
            <f' a' c''> <f' a' c''> <f' a' c''> <f' a' c''> |
            ...
            <f' a' c''> <f' a' c''> <f' a' c''> <f' a' c''> |
            <e' g' bes' c''> <e' g' bes' c''> <e' g' bes' c''> <e' g' bes' c''> |
            <f' a' c''> <f' a' c''> <f' a' c''> <f' a' c''> \mark "Chorus"
            |
            <f' a' c'' es''> <f' a' c'' es''> <f' a' c'' es''> <f' a' c'' es''> |
            <f' bes' d''> <f' bes' d''> <f' bes' d''> <f' bes' d''> |
            <g' bes' d''> <g' bes' d''> <g' bes' d''> <g' bes' d''> |
            <g' c'' e''> <g' c'' e''> <g' c'' e''> <g' c'' e''> |
            <a' c'' f''> <a' c'' f''> <a' c'' f''> <a' c'' f''> |
            <a' c'' es'' f''> <a' c'' es'' f''> <a' c'' es'' f''> <a' c'' es'' f''> |
            <bes' d'' f''> <bes' d'' f''> <bes' d'' f''> <bes' d'' f''> |
            <bes' d'' g''> <bes' d'' g''> <bes' d'' g''> <bes' d'' g''> |
            <c'' e'' g''> <c'' e'' g''> <c'' e'' g''> <c'' e'' g''> |
            <c'' f'' a''> <c'' f'' a''> <c'' f'' a''> <c'' f'' a''> \time 2/4
            \mark "Bridge"
            |
            <f' a' c'' es''> <f' a' c'' es''> \time 4/4
            |
            <c' e' g'> <c' e' g'> <c' e' g'> <c' e' g'> |
            <c' e' g' bes'> <c' e' g' bes'> <c' e' g' bes'> <c' e' g' bes'> \mark "Verse"
            |
            <f' a' c''> <f' a' c''> <f' a' c''> <f' a' c''> |
            <e' g' c''> <e' g' c''> <e' g' c''> <e' g' c''> |
            <e' g' bes' c''> <e' g' bes' c''> <e' g' bes' c''> <e' g' bes' c''> |
            ...
            <f' a' c''> <f' a' c''> <f' a' c''> <f' a' c''> |
            <e' g' bes' c''> <e' g' bes' c''> <e' g' bes' c''> <e' g' bes' c''> |
            <f' a' c''> <f' a' c''> <f' a' c''> <f' a' c''> \mark "Outro"
            |
            <f' a' c''> <f' a' c''> <f' a' c''> <f' a' c''> |
            <g' bes' es''> <g' bes' es''> <g' bes' es''> <g' bes' es''> |
            <f' bes' d''> <f' bes' d''> <f' bes' d''> <f' bes' d''> |
            <f' a' c''> <f' a' c''> <f' a' c''> <f' a' c''> |
            <f' a' c''> <f' a' c''> <f' a' c''> <f' a' c''> |
            <g' bes' es''> <g' bes' es''> <g' bes' es''> <g' bes' es''> |
